...
import com.cg.pecuniabank.service.CustomerService;
import com.cg.pecuniabank.util.CustomerRepository;
...
public class Client {
	...
	static void createAccount(Scanner scanner) throws ParseException
	{
		...
		//balance
		System.out.print("Enter the openeing balance of the account: ");
